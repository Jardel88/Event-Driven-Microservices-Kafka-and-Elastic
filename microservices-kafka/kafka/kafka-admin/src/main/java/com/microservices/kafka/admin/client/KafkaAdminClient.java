...
import com.microserviceskafka.config.KafkaConfigData;
import com.microserviceskafka.config.RetryConfigData;
...
public class KafkaAdminClient {
    ...
    public void checkCreateTopics(){
        ...
        for (String topic: kafkaConfigData.getTopicNamesToCreate()){
            while (!isTopicCrested(topics, topic)){
    ...
    private boolean isTopicCrested(Collection<TopicListing> topics, String topicName) {
        if(topics == null){
            return false;
        }
